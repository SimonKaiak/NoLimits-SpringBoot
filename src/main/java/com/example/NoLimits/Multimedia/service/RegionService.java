...
public class RegionService {
    ...
    public List<RegionModel> findAll() { return regionRepository.findAll(); }
    ...
    public void deleteById(Long id) {
        // 404 si no existe
        findById(id);
        // 409 si tiene comunas asociadas
        if (comunaRepository.existsByRegion_Id(id))
            throw new IllegalStateException("No se puede eliminar: la región tiene comunas asociadas.");
