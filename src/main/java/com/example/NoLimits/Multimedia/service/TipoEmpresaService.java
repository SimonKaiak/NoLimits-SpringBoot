// Ruta: src/main/java/com/example/NoLimits/Multimedia/service/TipoEmpresaService.java
...
public class TipoEmpresaService {
    ...
    public TipoEmpresaModel findById(Long id) {
        return tipoEmpresaRepository.findById(id)
                .orElseThrow(() -> new RecursoNoEncontradoException("Tipo de empresa no encontrado: " + id));
    }
    ...
    public void deleteById(Long id) {
        ...
        if (tiposEmpresaRepository.existsByTipoEmpresa_Id(id)) {
            throw new IllegalStateException("No se puede eliminar: hay relaciones en tipos_empresa.");
        }
